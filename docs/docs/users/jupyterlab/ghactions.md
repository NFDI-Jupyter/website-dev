...
1 - **Get Jupyter4NFDI API Token** - Browse to [https://hub.nfdi-jupyter.de/hub/token](https://hub.nfdi-jupyter.de/hub/token) , log in and request a new API token. Give it a useful note like "_Repo_ GitHub Action". Copy that token.  
